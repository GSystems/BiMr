...
public enum EbirdsEnum {
	...
	RECENT_NEARBY_NOTABLE_OBSERVATIONS("http://ebird.org/ws1.1/data/notable/geo/recent?lng=-76.51&lat=42.46&dist=2&back=5&maxResults=500&detail=simple&locale=en_US&fmt=json"),
	...
	RECENT_NOTABLE_OBSERVATIONS_AT_HOTSPOTS("http://ebird.org/ws1.1/data/notable/hotspot/recent?r=L99381&back=5&maxResults=500&detail=simple&locale=en_US&fmt=json"),
	...
	RECENT_NOTABLE_OBSERVATIONS_IN_REGION("http://ebird.org/ws1.1/data/notable/region/recent?rtype=subnational1&r=US-NV&back=5&maxResults=500&locale=en_US&fmt=json"),
